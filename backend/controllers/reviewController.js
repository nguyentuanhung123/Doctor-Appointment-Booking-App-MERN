 ...
 * Nó trích xuất dữ liệu cần thiết từ cơ thể yêu cầu và đặt các giá trị mặc định nếu không được cung cấp (doctor và user).
 * Sau đó, nó tạo một phiên bản mới của mô hình Review với dữ liệu đã trích xuất. Sau khi lưu đánh giá mới vào cơ sở dữ liệu, 
