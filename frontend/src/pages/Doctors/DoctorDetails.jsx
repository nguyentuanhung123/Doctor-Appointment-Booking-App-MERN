                ...
                <div className="grid md:grid-cols-3 gap-[50px]">
                    <div className='md:col-span-2'>
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 px-6
                                ...
                                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>
                                    A Swiss-French physician, bacteriologist and explorer. 
                                    He is famous for being the first to discover the bacillus that causes the bubonic plague, 
                                </p>
                            </div>
                        </div>
