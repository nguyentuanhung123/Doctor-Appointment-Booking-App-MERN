                        ...
                        <div>
                            <div className='lg:w-[570px]'>
                                ...
                                <p className='text__para'>
                                    The Best Hospital in Dubai - 254-bed multi-specialty facility with 40+ medical and surgical specialties.
                                </p>
                        ...
                        <div className='xl:w-[670px]'>
                            ...
                            <ul className="pl-4">
                                <li className="text__para">
                                    1. Schedule the appoiment directly.
                                </li>
                                <li className="text__para">
                        ...
                        <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                            ...
                            md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                                ...
                                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                                    ...
                                    <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700]'>Wayne Collins</h4>
                                </div>
