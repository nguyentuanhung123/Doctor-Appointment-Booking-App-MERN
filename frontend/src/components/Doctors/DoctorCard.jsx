...
const DoctorCard = ({doctor}) => {
    ...
    const { name, avgRating, totalRating, photo, totalPatients, hospital, specialization } = doctor;
        ...
        <div className='p-3 lg:p-5'>
            ...
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-[6px]">
                    <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] leading-7
